...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    /*
     * Commented out below 3 lines and a line after based on recommendataion from
     * forum
     */
    /*
    ...
    if (DriverStation.isTest()) {
      ...
      /*
       * commented out below as that function is commented out in
       * swervesubsystems.java
       */
      ...
      // Reef alignment
      // driverXbox.povRight().onTrue(new AlignToReefTagRelative(1,
      // drivebase).withTimeout(3));
      // driverXbox.povLeft().onTrue(new AlignToReefTagRelative(0,
      // drivebase).withTimeout(3));
      // driverXbox.povUp().onTrue(new AlignToReefTagRelative(2,
      // drivebase).withTimeout(3));
