...
public class Robot extends TimedRobot {
  ...
  // public static PIDController motor_elevator_one_pidc = new PIDController(0.2,
  // 0, 0.001); // Tune PID values
  // public static PIDController motor_elevator_two_pidc = new PIDController(0.2,
  // 0, 0.001); // Tune PID values
  ...
  // public static SparkClosedLoopController algae_raise_motor_pidc; // Tune PID
  // values
  ...
  public void robotInit() {
    ...
    // motor_elevator_one = new SparkMax(21, MotorType.kBrushless); // SparkMax is
    // flashed to CAN id 9
    // motor_elevator_two = new SparkMax(22, MotorType.kBrushless); // SparkMax is
    // flashed to CAN id
    SparkMaxConfig config_ = new SparkMaxConfig();
    config_.idleMode(SparkBaseConfig.IdleMode.kBrake);
    // motor_intake_one.configure(config_, SparkBase.ResetMode.kResetSafeParameters,
    // SparkBase.PersistMode.kPersistParameters);
    // motor_elevator_one.configure(config_,
    // SparkBase.ResetMode.kResetSafeParameters,
    // SparkBase.PersistMode.kPersistParameters);
    // motor_elevator_two.configure(config_,
    // SparkBase.ResetMode.kResetSafeParameters,
    // SparkBase.PersistMode.kPersistParameters);
    // motor_algae.configure(config_, SparkBase.ResetMode.kResetSafeParameters,
    // SparkBase.PersistMode.kPersistParameters);
    // motor_arm.configure(config_, SparkBase.ResetMode.kResetSafeParameters,
    // SparkBase.PersistMode.kPersistParameters);

    // motor_elevator_one_encoder = motor_elevator_one.getEncoder();
    // motor_elevator_two_encoder = motor_elevator_two.getEncoder();
    // System.out.println("ELE1 POSITION BEFORE SET 0:" +
    // motor_elevator_one_encoder.getPosition());
    // System.out.println("ELE2 POSITION BEFORE SET 0:" +
    // motor_elevator_two_encoder.getPosition());
    // System.out.flush();
    // System.out.flush();
    // motor_elevator_one_encoder.setPosition(0);
    // motor_elevator_two_encoder.setPosition(0);
    // Timer.delay(0.02);
    // System.out.println("ELE1 POSITION AFTER SET 0:" +
    // motor_elevator_one_encoder.getPosition());
    // System.out.println("ELE2 POSITION AFTER SET 0:" +
    // motor_elevator_two_encoder.getPosition());
    // System.out.flush();
    // System.out.flush();
    // INIT_ENCODER = motor_elevator_one_encoder.getPosition(); // INITIAL ENCOER
    // VALUE
    ...
    // algae_spin_motor = new SparkFlex(32, MotorType.kBrushless); // SparkMax is
    // flashed to CAN id

    // algae_raise_motor = new SparkFlex(31, MotorType.kBrushless); // SparkMax is
    // flashed to CAN id
    ...
    // algae_raise_motor.configure(config2_,
    // SparkBase.ResetMode.kResetSafeParameters,
    // SparkBase.PersistMode.kPersistParameters);

    // algae_raise_motor_encoder = algae_raise_motor.getEncoder();
    // algae_raise_motor_encoder.setPosition(0.0); // Assume arm is hanging down at
    // boot
    ...
    Trigger yButton = new JoystickButton(exampleController, XboxController.Button.kLeftBumper.value); // Creates a new
                                                                                                      // JoystickButton
                                                                                                      // object for the
                                                                                                      // `Y` button on
                                                                                                      // exampleController
    Trigger xButton = new JoystickButton(exampleController, XboxController.Button.kLeftBumper.value); // Creates a new
                                                                                                      // JoystickButton
                                                                                                      // object for the
                                                                                                      // `Y` button on
                                                                                                      // exampleController

    Trigger bButton = new JoystickButton(exampleController, XboxController.Button.kLeftBumper.value); // Creates a new
                                                                                                      // JoystickButton
                                                                                                      // object for the
                                                                                                      // `Y` button on
                                                                                                      // exampleController
  ...
  public void disabledInit() {
     ...
     * 
     * System.out.
     * println("TELEOP DISABLED : ELE MOTOR NOW IN COAST MODE , NOT BRAKE ");
  ...
  public void autonomousInit() {
     ...
     * timer.start();
     * ranAutoTest = false;
     * System.out.println("Starting test: initial pose = " +
  ...
  // double rawpidoutput = motor_elevator_one_pidc.calculate(currentPosition,
  // targetRotations) ;
  // //double pidOutput = MathUtil.clamp(rawpidoutput,-0.15,0.25);

  // double pidOutput = scale(rawpidoutput,-1,1,-0.15,0.3);
  // //System.out.println("RAW PID : " + rawpidoutput + " : CLAMPED : " +
  // pidOutput);
  ...
  // {
  // motor_elevator_two.set(0.25); // NO NEGETIVE NEEDED FOR ONE MOTOR DUE TO
  // DESIGN
  // motor_elevator_one.set(0.25); // NO NEGETIVE NEEDED FOR ONE MOTOR DUE TO
  // DESIGN
  ...
  // }else // DOWN SPEED SET
  // {
  // motor_elevator_two.set(-0.2); // NO NEGETIVE NEEDED FOR ONE MOTOR DUE TO
  // DESIGN
  // motor_elevator_one.set(-0.2); // NO NEGETIVE NEEDED FOR ONE MOTOR DUE TO
  // DESIGN
  ...
  // Stop if close enough OR if the PID output changes direction (prevents
  // overshoot)
  // if ((Math.abs(error) < 0.1) && targetRotations == 0)
  // {
  // System.out.println("AT HOME HEIGHT - SETTING 0 FEED FORWARD");
  // System.out.println( " : errorval : " + error + ": currentPosition : " +
  // motor_elevator_one_encoder.getPosition()) ;
  ...
  public void moveDistance(double inchesdist) {
    ...
    // motor_elevator_one_encoder.getPosition());
    // System.out.println( " : ERRORVAL : " + (targetRotations -
    // motor_elevator_one_encoder.getPosition()));
  }
